...
* Easy definition of keyinput to watch for with Strings ("start"), keyCodes ([65,66,67]) or both (["start", 65, 66, "end"])
...
Register sequences with a String, keyCode Array or both:
	...
	watcher.watch(["xx", 65, 66, "xx"], func);	// callback when user types "xx", afterwards keys 65, 66, afterwards "xx"

Registering sequences with a String currently supports a..ZA..Z0..1 and SPACE, so "hello world" will work, but "hello#^" fails.
